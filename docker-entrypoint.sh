...
update_env_config() {
  ...
  sed -i "s|\"REACT_APP_AZURE_CLIENT_ID\": \"[^\"]*\"|\"REACT_APP_AZURE_CLIENT_ID\": \"$REACT_APP_AZURE_CLIENT_ID\"|g" "$ENV_FILE"
  sed -i "s|\"REACT_APP_AZURE_TENANT_ID\": \"[^\"]*\"|\"REACT_APP_AZURE_TENANT_ID\": \"$REACT_APP_AZURE_TENANT_ID\"|g" "$ENV_FILE"
